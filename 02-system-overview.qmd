...
@tbl-HLC summarises the key characteristics of the Brazilian and European air navigation system for 2024.
...
#| fig-cap: "Share of international connections in 2024"
...
Traffic from Brazil to Europe (i.e., Eurocontrol Member States) accounts for just under 2% of the total traffic volume. Europe has a shallow share of flights going to Southern America.
...
Accordingly, flight to Columbia and Uruguay from the study airports account for a smaller fraction, and there is a multitude of other connections to South America and the Carribean.
...
These reflect to a large extent individual flights (e.g. State flights, specific cargo operations), and only contribute to a small extent to the overall traffic between both regions.\
