...
A strong segment of the market represents flights to/from Argentina and Chile accounting for about half of the flights departing from the airports in this study. Accordingly, flight to Columbia and Uruguay from the study airports account for a smaller fraction, and there is a multitude of other connections to South America and the Carribean.
...
Individual connections of less than 90 flights per year are aggregated into an "other" group. These reflect to a large extent individual flights (e.g. State flights, specific cargo operations), and only contribute to a small extent to the overall  traffic between both regions.    
