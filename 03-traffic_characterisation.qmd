...
#| fig-cap: European airport level traffic
#| warning: false
...
Such contraints reduce the available runway system capacity, and thus, the serviced peak traffic is also impacted by the runway system configuration.
...
The wider spread of internatinoal connections across all chosen airports shows a less centralised global connectivity model.
