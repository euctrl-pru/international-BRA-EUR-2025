...
In contrast, the European region displays strong seasonality, with pronounced peaks during the summer months (June to September) and sharp drops in winter. This pattern aligns with Europe’s tourism-driven traffic, where demand is concentrated in holiday periods. While traffic levels have improved, the variation between seasons remains substantial.
...
::: callout note
Graph is not clear. and is not appears Amsterdan, Heatrow and Paris levels
::: 
...
In addition, the share of total traffic handled by the top airports in Brazil has shown a slight downward trend from 2022 to 2024, suggesting a modest redistribution of traffic across a broader set of airports. This may result from regional recovery, airline strategy shifts, or temporary infrastructure limitations—such as the closure of SBPA and the restrictions at SBRJ.

In contrast, in Europe, the share of traffic managed by the busiest airports has shown a slight increase over the same period. This upward movement reflects a temporary concentration of demand as the region works toward pre-pandemic recovery levels, particularly through well-established hubs. Importantly, none of the airports included in this report experienced a decline in traffic, with Madrid and Barcelona recording substantial growth close to 20%, and Gatwick rising by more than 10%, reinforcing their position within the European network.
...
=======
```{r}
>>>>>>> 9188882dd18915b914771c12bb68c394deefa69b
...
::: callout note
Is it possible to include rwy number on the graph of the last 3 years peak day?
No peak day graphs for europe?
::: 
...
In contrast, major European hubs like Frankfurt (EDDF), Heathrow (EGLL), and Charles de Gaulle (LFPG) operate with a higher proportion of “heavy” aircraft, in line with their function as large-scale global connection points. These structural differences reflect how each region organizes its connectivity: Brazil tends to centralize long-haul operations in a few key airports, while Europe distributes them across a broader set of hubs.
