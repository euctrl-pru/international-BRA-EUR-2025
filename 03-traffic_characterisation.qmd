...
The group of latter airport often operate a more robust infrastructure (such as more runways). 
...
However, it is important to note that in many of these cases, the runway system does not support fully independent operations on all available runways, thus, reducing the available runway system capacity. 
The serviced peak traffic is also impacted by the runway system configuration.
...
This show the importance of analysing peak day traffic as a complementary indicator to average daily movements, especially during periods of recovery or operational adjustments.
...
Generally, a higher share of “heavy” aircraft can reduce runway throughput due to wake turbulence separation requirements and longer landing and takeoff times.
...
Light-type traffic at the study airports remain the exemption. A higher share of heavy aircraft is observed at the top-European airport in this study. The wider spread of internatinoal connections across all chosen airports shows a less centralised global connectivity model.
