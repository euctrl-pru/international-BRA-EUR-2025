...
punc_bra <- read_csv("./data_proc/BRA-punc.csv") |>  
  mutate(REGION = "BRA") |> 
...
punc_bra_month <- read_csv("./data_proc/BRA-punc.csv") |>  
...
month_tfc_bra <- read_csv("./data_proc/study_apt_lvl_month.csv")
month_names <- c("Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec")
...
study_apt_lvl  <- read_csv("./data_proc/study_apt_lvl.csv")
