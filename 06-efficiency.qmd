...
For most Brazilian airports, a reduction in additional asms times was observed, which is a positive development. A particular highlight is Santos Dumont (SBRJ), where the average additional time decreased by more than one minute compared to the previous year.

In contrast, European airports generally experienced a slight increase in taxi-out times between 2023 and 2024.
...
::: callout-note
The graph doesn have european data.
The text didnt updated
...
This chapter analyzed operational efficiency through the assessment of additional taxi-in and taxi-out times, as well as additional time in terminal airspace.
...
The mapping of taxi-in and taxi-out times confirmed that overall taxi-out inefficiencies remain more significant than taxi-in inefficiencies. Improvements were more pronounced in Brazil for taxi-in operations, whereas Europe showed stability with exceptions like Heathrow (EGLL) and Rome (LIRF), which still faced increased inefficiencies.

The analysis of additional time in terminal airspace further indicated that European airports generally manage arrival flows with less delay compared to Brazilian airports. However, Brazilian airports showed positive trends, with reductions observed at most locations—highlighted again by the strong improvement at Santos Dumont.
